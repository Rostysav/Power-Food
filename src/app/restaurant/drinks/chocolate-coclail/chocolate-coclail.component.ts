...
@Component({
  selector: 'pf-chocolate-coclail',
  templateUrl: './chocolate-coclail.component.html',
  styleUrls: ['./chocolate-coclail.component.scss']
})
export class ChocolateCoclailComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
  ...
  restaurants: IRestaurant[] = [
    {
      'id': 15,
      'name': 'Протеїновий коктейль зі смаком шоколаду - 360 мл',
      ...
      'price': 57,
      'imageUrl': '../../../../assets/img/restourant/coctails/chocolate-coclail.jpg'
    }
  ];
