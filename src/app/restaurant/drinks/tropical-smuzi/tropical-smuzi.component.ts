...
@Component({
  selector: 'pf-tropical-smuzi',
  templateUrl: './tropical-smuzi.component.html',
  styleUrls: ['./tropical-smuzi.component.scss']
})
export class TropicalSmuziComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
