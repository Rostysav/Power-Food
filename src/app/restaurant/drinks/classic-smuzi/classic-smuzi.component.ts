...
@Component({
  selector: 'pf-classic-smuzi',
  templateUrl: './classic-smuzi.component.html',
  styleUrls: ['./classic-smuzi.component.scss']
})
export class ClassicSmuziComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
