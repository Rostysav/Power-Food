...
@Component({
  selector: 'app-spring-roll-veal',
  templateUrl: './spring-roll-veal.component.html',
  styleUrls: ['./spring-roll-veal.component.scss']
})
export class SpringRollVealComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
