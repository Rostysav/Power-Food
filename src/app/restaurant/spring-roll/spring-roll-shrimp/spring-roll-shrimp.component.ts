...
@Component({
  selector: 'app-spring-roll-shrimp',
  templateUrl: './spring-roll-shrimp.component.html',
  styleUrls: ['./spring-roll-shrimp.component.scss']
})
export class SpringRollShrimpComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
