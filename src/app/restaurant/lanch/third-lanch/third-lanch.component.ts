...
@Component({
  selector: 'app-third-lanch',
  templateUrl: './third-lanch.component.html',
  styleUrls: ['./third-lanch.component.scss']
})
export class ThirdLanchComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
