...
@Component({
  selector: 'app-second-lanch',
  templateUrl: './second-lanch.component.html',
  styleUrls: ['./second-lanch.component.scss']
})
export class SecondLanchComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
  ...
  restaurants: IRestaurant[] = [
    {
      'id': 5,
      'name': 'Ланч N2 132/200г з 12:00 - 15:00',
      ...
      'price': 138,
      'imageUrl': '../../../../assets/img/restourant/lanch/lanch-2.jpg'
    }
  ];
