...
@Component({
  selector: 'app-bulgur-vegitables',
  templateUrl: './bulgur-vegitables.component.html',
  styleUrls: ['./bulgur-vegitables.component.scss']
})
export class BulgurVegitablesComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
