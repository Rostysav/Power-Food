...
@Component({
  selector: 'app-kinoa-vegitables',
  templateUrl: './kinoa-vegitables.component.html',
  styleUrls: ['./kinoa-vegitables.component.scss']
})
export class KinoaVegitablesComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
