...
@Component({
  selector: 'app-telyacha-vurizka',
  templateUrl: './telyacha-vurizka.component.html',
  styleUrls: ['./telyacha-vurizka.component.scss']
})
export class TelyachaVurizkaComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
