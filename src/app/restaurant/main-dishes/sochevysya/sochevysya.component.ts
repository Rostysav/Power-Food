...
@Component({
  selector: 'app-sochevysya',
  templateUrl: './sochevysya.component.html',
  styleUrls: ['./sochevysya.component.scss']
})
export class SochevysyaComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
