...
@Component({
  selector: 'app-tyrkey-file',
  templateUrl: './tyrkey-file.component.html',
  styleUrls: ['./tyrkey-file.component.scss']
})
export class TyrkeyFileComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
