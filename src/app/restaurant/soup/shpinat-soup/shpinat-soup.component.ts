...
@Component({
  selector: 'app-shpinat-soup',
  templateUrl: './shpinat-soup.component.html',
  styleUrls: ['./shpinat-soup.component.scss']
})
export class ShpinatSoupComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
  ...
  restaurants: IRestaurant[] = [
    {
      'id': 7,
      'name': 'Суп шпинатний з броколі - 320 г',
      ...
      'price': 62,
      'imageUrl': '../../../../assets/img/restourant/soup/shpinat-soup.jpg'
    }
  ];
  ...
  orderProduct() {
    let myArray =
      { id: 1,
        name:"ССуп шпинатний з броколі - 320 г",
