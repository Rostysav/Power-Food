...
@Component({
  selector: 'app-pumpkin-soup',
  templateUrl: './pumpkin-soup.component.html',
  styleUrls: ['./pumpkin-soup.component.scss']
})
export class PumpkinSoupComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
