...
@Component({
  selector: 'app-carrot-soup',
  templateUrl: './carrot-soup.component.html',
  styleUrls: ['./carrot-soup.component.scss']
})
export class CarrotSoupComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
  ...
  restaurants: IRestaurant[] = [
    {
      ...
      'price': 62,
      'imageUrl': '../../../../assets/img/restourant/soup/carrot-soup.jpg'
    }
  ];
