...
@Component({
  selector: 'app-guakamole',
  templateUrl: './guakamole.component.html',
  styleUrls: ['./guakamole.component.scss']
})
export class GuakamoleComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
