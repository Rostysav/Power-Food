...
@Component({
  selector: 'app-rostfib',
  templateUrl: './rostfib.component.html',
  styleUrls: ['./rostfib.component.scss']
})
export class RostfibComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
  ...
  restaurants: IRestaurant[] = [
    {
      'id': 7,
      'name': 'Брускета з ростбіфом-185г',
