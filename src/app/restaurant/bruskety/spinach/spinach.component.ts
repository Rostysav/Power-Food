...
@Component({
  ...
  styleUrls: ['./spinach.component.scss']
})
export class SpinachComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
  ...
  restaurants: IRestaurant[] = [
    {
      'id': 8,
      'name': 'Брускета з тушеним шпинатом  -200г',
      ...
      'price': 78,
      'imageUrl': '../../../../assets/img/restourant/bryskety/brysketa-spinach.jpg'
    }
  ];
