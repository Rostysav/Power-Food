...
@Component({
  selector: 'pf-cheese-pear',
  templateUrl: './cheese-pear.component.html',
  styleUrls: ['./cheese-pear.component.scss']
})
export class CheesePearComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
