...
@Component({
  selector: 'app-bylgyr-salat',
  templateUrl: './bylgyr-salat.component.html',
  styleUrls: ['./bylgyr-salat.component.scss']
})
export class BylgyrSalatComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
  ...
  restaurants: IRestaurant[] = [
    {
      'id': 7,
      'name': 'Салат з індичкою та булгуру - 200 г',
      ...
      'price': 88,
      'imageUrl': '../../../../assets/img/restourant/salaty/bylgyr-salat.jpg'
    }
  ];
  ...
  orderProduct() {
    let myArray =
      { id: 1,
        name:"Салат з індичкою та булгуру - 200 г",
        price: this.item*88 || 88,
        pieces: (this.item*88 || 88)/88,
        imageUrl: "../../../../assets/img/restourant/salaty/bylgyr-salat.jpg"
      };
    let get_item = [];
