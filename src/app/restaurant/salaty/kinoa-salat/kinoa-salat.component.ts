...
@Component({
  selector: 'app-kinoa-salat',
  templateUrl: './kinoa-salat.component.html',
  styleUrls: ['./kinoa-salat.component.scss']
})
export class KinoaSalatComponent implements OnInit, OnChanges {
  buttonText = 'Замовити';
  orderText = 'В корзину';
